...
const NavMobile = () => {
    ...
    // lorsque l'on change de page la nav disparait
    useEffect(() => {
    ...
    useEffect(() => {
        ...
        const menuHandleClick = () => {
            // on transforme le menu en croix et inversement au clique de celui-ci
                        ...
                        <li className='nav-link declencheur'>
                            <h1>
                                ...
                                <span className='arrow'>
                                    <img src={arrowBleu} alt='arrow' className='arrow'/>
                                </span>
                            </h1>
                            <div className='solutions'>
                                ...
                                <Link to={'social'} className='solution-element'>
                                    ...
                                    <p>Gérez efficacement votre présence en ligne avec la gestion de vos réseaux, 
                                    de serveurs Discord..</p>
                                </Link>
                                ...
                                <Link to={'veille'} className='solution-element'>
                                    <h1 >Veille</h1>
                                    <p>Gagnez du temps et de la précision dans votre prise de décision avec 
                                    une bonne veille opérationnelle..</p>
                                </Link>
                                ...
                                <Link to={'formation'} className='solution-element'>
                                    ...
                                    <p> Acquérez de nouvelles compétences et ressources avec nos formations en ligne 
                                    et eBooks.</p>
                                </Link>
                            </div>
                        </li>
